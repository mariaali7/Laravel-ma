                ...
                function (direction) {
                    if (
                        ...
                        $(".number").each(function () {
                            ...
                            // Define individual durations based on the number
                            var duration = 2000; // Default duration

                            if (num <= 50) {
                                duration = 1000; // Faster for small numbers
                            } else if (num <= 100) {
                                duration = 500; // Medium speed for medium numbers
                            }
